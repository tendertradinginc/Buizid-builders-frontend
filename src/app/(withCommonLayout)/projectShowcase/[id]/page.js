  ...
  return (
    <div className="mt-16 px-2">
      <div className="my-20 pt-10">
        <div>
          <h2 className="text-black text-base text-center font-bold">
            EXPLORE FEATURES
          </h2>
          <h1 className="text-black text-2xl text-center font-bold mt-4">
            Presenting Our Successful Project
          </h1>
          <Breadcrumb className="flex justify-center mt-5">
            <BreadcrumbList>
              ...
              <BreadcrumbItem>
                <BreadcrumbLink asChild>
                  <Link className="text-gray-500" href="/projectShowcase">
                    Projects
                  </Link>
                </BreadcrumbLink>
              </BreadcrumbItem>
        ...
        <div className="min-h-[100vh] container mx-auto">
          <div className="text-justify mt-28">
            ...
            <h1 className="text-black text-xl py-4 font-bold">
              Photo Gallery From Site
            </h1>
            ...
            <div>
              ...
              <div className="mt-20">
                <h1 className="font-semibold text-gray-700 text-xl"></h1>
                <br />
